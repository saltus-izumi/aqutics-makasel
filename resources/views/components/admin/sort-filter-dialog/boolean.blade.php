    ...
    <div class="tw:space-y-2">
        <div>
            ...
            <div class="tw:flex tw:gap-2">
                <label class="tw:inline-flex tw:items-center tw:gap-1">
                    <input type="radio" name="boolean_sort" class="tw:accent-blue-600" value="asc" x-model="{{ $sortModel }}">
                    <span class="tw:text-sm">{{ $ascLabel }}</span>
                </label>
                <label class="tw:inline-flex tw:items-center tw:gap-1">
                    <input type="radio" name="boolean_sort" class="tw:accent-blue-600" value="desc" x-model="{{ $sortModel }}">
        ...
        <div>
            ...
            <div class="tw:flex tw:gap-3">
                <label class="tw:inline-flex tw:items-center tw:gap-1">
                    <input type="radio" name="boolean_condition" class="tw:accent-blue-600" value="not_blank" x-model="{{ $blankModel }}">
                    <span class="tw:text-sm">{{ $trueLabel }}</span>
                </label>
                <label class="tw:inline-flex tw:items-center tw:gap-1">
                    <input type="radio" name="boolean_condition" class="tw:accent-blue-600" value="blank" x-model="{{ $blankModel }}" x-on:change="handleFilterBlankChange($event)">
                    <span class="tw:text-sm">{{ $falseLabel }}</span>
                </label>
            </div>
        </div>
