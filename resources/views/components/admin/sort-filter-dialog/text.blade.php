    ...
    <div class="tw:space-y-2">
        <div>
            ...
            <div class="tw:flex tw:gap-2">
                <label class="tw:inline-flex tw:items-center tw:gap-1">
                    <input type="radio" name="text_sort" class="tw:accent-blue-600" value="asc" x-model="{{ $sortModel }}">
                    <span class="tw:text-sm">{{ $ascLabel }}</span>
                </label>
                <label class="tw:inline-flex tw:items-center tw:gap-1">
                    <input type="radio" name="text_sort" class="tw:accent-blue-600" value="desc" x-model="{{ $sortModel }}">
        ...
        <div>
            ...
            <div class="tw:flex tw:gap-3 tw:mb-2">
                <label class="tw:inline-flex tw:items-center tw:gap-1">
                    <input type="radio" name="text_empty" class="tw:accent-blue-600" value="blank" x-model="{{ $blankModel }}" x-on:change="handleFilterBlankChange($event)">
                    <span class="tw:text-sm">{{ $blankLabel }}</span>
                </label>
                <label class="tw:inline-flex tw:items-center tw:gap-1">
                    <input type="radio" name="text_empty" class="tw:accent-blue-600" value="not_blank" x-model="{{ $blankModel }}">
