<div
    x-data="enIndividualEmergencyContact({
        initialFields: @js([
            ...
            'postal_code' => $enProgressEmergencyContact?->postal_code,
            'prefecture' => $enProgressEmergencyContact?->prefecture,
            'city' => $enProgressEmergencyContact?->city,
            'street' => $enProgressEmergencyContact?->street,
            'building' => $enProgressEmergencyContact?->building,
            'phone_number' => $enProgressEmergencyContact?->phone_number,
            ...
            'workplace_or_school_kana' => $enProgressEmergencyContact?->workplace_or_school_kana,
...
>
    ...
    <div class="tw:flex">
        ...
        <div class="tw:w-[286px] tw:h-[42px] tw:text-center tw:border tw:border-[#cccccc] tw:border-t-0 tw:border-l-0">
            <x-form.input name="workplace_or_school_kana" :value="$enProgressEmergencyContact?->workplace_or_school_kana" class="tw:!h-[40px] tw:!text-center" :border="false" />
        </div>
    </div>
</div>
...
@push('scripts')
    <script>
        (() => {
            window.enIndividualEmergencyContact = (params = {}) => ({
