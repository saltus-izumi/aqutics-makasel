    ...
    <div class="tw:pt-[21px] tw:flex tw:gap-x-[38px]">
        <div class="tw:w-[532px] tw:flex tw:flex-col tw:gap-y-[21px]">
            <div>
                ...
                <x-form.select-search name="owner_id" wire:model.live="ownerId" :options="$ownerOptions" :empty="true" :value="$ownerId" class="tw:text-[1.2rem]" :readonly="$teProgressId" />
            ...
            <div>
                ...
                <x-form.select-search name="investment_id" wire:model.live="investmentId" :options="$investmentOptions" :empty="true" :value="$investmentId" class="tw:text-[1.2rem]" :readonly="$teProgressId" />
            ...
            <div>
                ...
                <x-form.select-search name="investment_room_id" wire:model.live="investmentRoomId" :options="$investmentRoomOptions" :empty="true" :value="$investmentRoomId" class="tw:text-[1.2rem]" :readonly="$teProgressId" />
    ...
    @if ($teProgress)
        ...
        <div class="tw:mt-[21px]">
            ...
            @foreach ($teProgress->completionPhotoFiles as $completionPhotoFile)
                <x-form.checkbox name="completion_photo_files[]" :value="$completionPhotoFile->id">{{ $completionPhotoFile->file_name }}</x-form.checkbox>
            @endforeach
        </div>
    @endif
