<div class="tw:px-[20px] tw:w-fit">
    <div class="tw:border-b tw:pb-[21px] tw:h-[72px] tw:flex tw:items-end">
        <x-form.select-search name="operation_kind_id" wire:model.live="operation_kind_id" :options="$operationKindOptions" :empty="true" :value="$operation_kind_id" class="tw:text-[1.2rem] tw:w-[532px]" />
    </div>
    <div class="tw:pt-[21px] tw:flex tw:gap-x-[38px]">
        <div class="tw:w-[532px] tw:flex tw:flex-col tw:gap-y-[21px]">
            <div>
                ...
                <x-form.select-search name="owner_id" wire:model.live="owner_id" :options="$ownerOptions" :empty="true" :value="$owner_id" class="tw:text-[1.2rem]" />
            ...
            <div>
                ...
                <x-form.select-search name="investment_id" wire:model.live="investment_id" :options="$investmentOptions" :empty="true" :value="$investment_id" class="tw:text-[1.2rem]" />
            ...
            <div>
                ...
                <x-form.select-search name="operation_template_id" wire:model.live="operation_template_id" :options="$operationTemplateOptions" :empty="true" :value="$operation_template_id" class="tw:text-[1.2rem]" />
