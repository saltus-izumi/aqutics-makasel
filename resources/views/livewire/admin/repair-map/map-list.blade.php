<div class="tw:h-full tw:w-full tw:overflow-auto tw:bg-white">
    <div class="tw:h-[367px] tw:w-full tw:sticky tw:top-0 tw:bg-white tw:z-10">
        <div class="tw:h-[80px] tw:sticky tw:top-0 tw:bg-white tw:z-10">
            <div class="tw:font-bold tw:text-[1.3rem]">物件選択</div>
            <x-form.input class="tw:!w-[220px]" placeholder="物件名（ID）、オーナー名" />
        </div>
        <div class="tw:h-[120px] tw:sticky tw:top-[80px] tw:bg-white tw:z-10">
        ...
        <div class="tw:h-[120px] tw:sticky tw:top-[200px] tw:bg-white tw:z-10">
        ...
        <div class="tw:sticky tw:top-[320px] tw:font-bold tw:text-[1.3rem] tw:!w-[840px] tw:bg-white tw:border-b tw:z-10">取引先</div>
        <div class="tw:h-[20px] tw:full tw:sticky tw:top-[347px] tw:bg-white"> </div>
    </div>
