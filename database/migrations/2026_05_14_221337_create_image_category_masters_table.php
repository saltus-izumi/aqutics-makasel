...
return new class extends Migration
{
    ...
    {
        Schema::create('image_category_masters', function (Blueprint $table) {
            $table->id();
            $table->integer('category_kind')->nullable()->comment('画像カテゴリ種別');
    ...
    {
        Schema::dropIfExists('image_category_masters');
    }
};
