...
return new class extends Migration
{
    ...
    {
        Schema::create('equipment_category2_masters', function (Blueprint $table) {
            $table->id();
            $table->integer('equipment_category1_master_id')->nullable()->comment('大カテゴリID');
            $table->string('item_name')->nullable()->comment('名称');
            $table->integer('disp_rank')->nullable()->comment('並び順');
