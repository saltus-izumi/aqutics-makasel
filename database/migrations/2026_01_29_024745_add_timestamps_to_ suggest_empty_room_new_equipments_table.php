...
return new class extends Migration
{
    ...
    {
        Schema::table('suggest_empty_room_new_equipments', function (Blueprint $table) {
            $table->integer('created_user_id')->nullable()->comment('データ登録スタッフID')->after('new_condition');
        ...
        // DB::table('suggest_empty_room_new_equipments')
        //     ->where('deleted', 1)
