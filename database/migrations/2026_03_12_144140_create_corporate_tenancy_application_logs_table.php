    ...
    public function up(): void
    {
        Schema::create('corporate_tenancy_application_logs', function (Blueprint $table) {
            ...
            $rawColumns = [
                ...
                ['varchar', 'desired_move_in_date', '賃貸物件内容入居予定日'],
                ['varchar', 'desired_contract_date', '賃貸物件内容入居希望日'],
                ['varchar', 'initial_payment_due_date', '賃貸物件内容契約希望日'],
                ['varchar', 'tokio_marine_insurance_flag', '賃貸物件内容初期費用入金予定日'],
                ['varchar', 'tokio_marine_direct_insurance_flag', 'その他・保証会社東京海上ミレア少額短期保険株式会社/東京海上ウエスト少額短期保険株式会社(直接連携)'],
                ...
                ['varchar', 'corporate_emergency_contact_work_phone', '法人の緊急連絡先勤務先電話番号'],
                ...
                ['varchar', 'guarantor_birth_date', '法人の連帯保証人続柄'],
                ['varchar', 'guarantor_age', '法人の連帯保証人生年月日'],
                ['varchar', 'guarantor_relationship', '法人の連帯保証人年齢'],
                ...
                ['varchar', 'guarantor_residence_years', '法人の連帯保証人お勤め先職業'],
                ['varchar', 'guarantor_job', '法人の連帯保証人お勤め先勤務先/学校名'],
                ['varchar', 'guarantor_company_name', '法人の連帯保証人お勤め先勤務先/学校名（カナ）'],
                ['varchar', 'guarantor_company_name_kana', '法人の連帯保証人お勤め先勤務先電話番号'],
                ['varchar', 'guarantor_company_phone', '法人の連帯保証人お勤め先勤務先所在地（郵便番号）'],
                ['varchar', 'guarantor_company_zip', '法人の連帯保証人お勤め先勤務先所在地（都道府県）'],
                ['varchar', 'guarantor_company_prefecture', '法人の連帯保証人お勤め先勤務先所在地（市区町村）'],
                ['varchar', 'guarantor_company_city', '法人の連帯保証人お勤め先勤務先所在地（番地・丁目）'],
                ['varchar', 'guarantor_company_address', '法人の連帯保証人お勤め先勤務先所在地（建物名・部屋番号）'],
                ['varchar', 'guarantor_company_building', '法人の連帯保証人お勤め先業種'],
                ['varchar', 'guarantor_industry', '法人の連帯保証人お勤め先資本金'],
                ['varchar', 'guarantor_company_established_date', '法人の連帯保証人お勤め先従業員数'],
                ['varchar', 'guarantor_company_capital', '法人の連帯保証人お勤め先設立年月日'],
