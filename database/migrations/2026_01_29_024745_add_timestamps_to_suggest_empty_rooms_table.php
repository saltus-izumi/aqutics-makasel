...
return new class extends Migration
{
    ...
    {
        Schema::table('suggest_empty_rooms', function (Blueprint $table) {
            $table->integer('created_user_id')->nullable()->comment('データ登録スタッフID')->after('comment');
