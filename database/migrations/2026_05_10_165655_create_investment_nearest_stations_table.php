...
return new class extends Migration
{
    ...
    {
        Schema::create('investment_nearest_stations', function (Blueprint $table) {
            $table->id();
            $table->integer('investment_id')->nullable()->comment('物件ID');
            $table->string('railway_name')->nullable()->comment('鉄道名');
            $table->string('line_name')->nullable()->comment('路線名');
            $table->string('station_name')->nullable()->comment('最寄り駅');
    ...
    {
        Schema::dropIfExists('investment_nearest_stations');
    }
};
