...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('en_progress_emergency_contacts')) {
            $backupTable = 'en_progress_emergency_contacts_' . date('YmdHis');
            if (Schema::hasTable($backupTable)) {
                throw new RuntimeException("{$backupTable} table already exists.");
            }

            Schema::rename('en_progress_emergency_contacts', $backupTable);
        }
