...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('en_progress_corporate_applicants')) {
            $backupTable = 'en_progress_corporate_applicants_' . date('YmdHis');
            if (Schema::hasTable($backupTable)) {
                throw new RuntimeException("{$backupTable} table already exists.");
            }

            Schema::rename('en_progress_corporate_applicants', $backupTable);
        }
