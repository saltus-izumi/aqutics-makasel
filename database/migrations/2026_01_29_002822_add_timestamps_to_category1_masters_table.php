...
return new class extends Migration
{
    ...
    {
        Schema::table('category1_masters', function (Blueprint $table) {
            $table->integer('created_user_id')->nullable()->comment('データ登録スタッフID')->after('te_flag');
