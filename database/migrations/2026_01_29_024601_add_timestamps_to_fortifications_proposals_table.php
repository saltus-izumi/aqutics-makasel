...
return new class extends Migration
{
    ...
    {
        Schema::table('fortifications_proposals', function (Blueprint $table) {
            $table->integer('created_user_id')->nullable()->comment('データ登録スタッフID')->after('completed_date');
        ...
        DB::table('fortifications_proposals')
            ->where('deleted', 1)
